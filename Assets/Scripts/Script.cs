...
public class WordScript : MonoBehaviour {
    ...
    public void setLines()
    {
        ...
        /*Puzzle 2*/ Lines.Add("Using the clock hands, you can direct the ball into the square");
        /*Puzzle 3*/ Lines.Add("Clock hands must align with the quadrant with their matching color to complete a puzzle. This game, as you can probably tell by now, is running in real time.");
        ...
        /*Puzzle 5*/ Lines.Add("This game isn’t meant to be entertaining.");
        //Section 2
        /*Puzzle 6*/ Lines.Add("A collection of minigames called “Penn and Teller’s Smoke and Mirror’s was developed and planned for release on the Sega CD in 1995, but was never distributed due to the downfall of the Sega CD. ");
        ...
        /*Puzzle 11*/ Lines.Add("At the time, there was an wide cultural outcry against violence in video games, and so, the developers sarcastically developed a game to display how exciting realistic video games could really be.");
        ...
        /*Puzzle 14*/ Lines.Add("The game is widely considered the worst video game ever made. But it successfully conveys a point; Realism does not make a game fun.");
        //SECTION 3
        /*Puzzle 15*/
        ...
        /*Puzzle 25*/ Lines.Add("You’ve certainly got better things to be doing with your time. There are much better puzzle games out there. I highly suggest the Portal games or Gorogoa, they’re great, really well designed and interesting.");
        ...
        /*Puzzle 63*/ Lines.Add("So, to be short, you’ve taken the bait. Congratulations.");
        //Section 11
